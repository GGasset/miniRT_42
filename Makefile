...
RT_C_FILES += vec3/vec3_access.c vec3/vec3_angles.c vec3/vec3.c vec3/vec3_color_interval.c \
			  vec3/vec3_matrix.c vec3/vec3_op.c vec3/vec3_vecop.c sphere.c plane.c \
			  cylinder.c cylinder_cap.c  cylinder_helpers.c  cylinder_lat.c camera_render.c ray_color.c
...
CC_SHARED_FLAGS=-O3 #-fsanitize=address
